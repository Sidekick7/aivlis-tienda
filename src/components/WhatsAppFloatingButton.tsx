...
export default function WhatsAppFloatingButton() {
  if (!storeConfig.whatsappNumber) return null;
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-40 flex items-center gap-2 rounded-full bg-[#25D366] p-3 text-white shadow-xl shadow-black/25 transition hover:-translate-y-0.5 hover:bg-[#20bd5a] sm:bottom-6 sm:right-6 sm:px-4"
    >
      <svg
        viewBox="0 0 32 32"
        aria-hidden="true"
