...
const updateProduct = async () => {
    ...
    const validationError = getProductFormError({
      ...
      productSaleActive: editingProduct.saleActive,
      productSalePrice: editingProduct.salePrice,
      productSaleCurvePrice: editingProduct.saleCurvePrice,
      productSaleStartsAt: editingProduct.saleStartsAt,
      productSaleEndsAt: editingProduct.saleEndsAt,
